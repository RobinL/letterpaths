  ...
  for (let charIndex = 0; charIndex < text.length; charIndex += 1) {
    ...
    if (prevExitCurve && prevChar) {
      ...
      joinMetrics.push({
        ...
        endpointAngleChangeDegrees: spacing.endpointAngleChangeDegrees,
        midpointTurnDegrees: spacing.midpointTurnDegrees,
        midpointBonusDegrees: spacing.midpointBonusDegrees,
        verticalLiftFactor: spacing.verticalLiftFactor,
        alignmentFactor: spacing.alignmentFactor,
        entryResolutionHorizontality: spacing.entryResolutionHorizontality,
        horizontalDemandFactor: spacing.horizontalDemandFactor,
