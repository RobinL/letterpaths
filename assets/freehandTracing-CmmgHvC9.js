import"./modulepreload-polyfill-B5Qt9EMX.js";import{c as de}from"./style-C7wl_Z-J.js";import"./joiner-CtOGZvQI.js";import{M as ge,d as _e,T as he,f as fe,g as Z,c as we,W as z,a as me,e as ye}from"./shared-CCQY4f2Y.js";const k="zephyr",be=84,W=fe,U=70,ve=0,xe=120,Se=1,G=5,$e=["word","tolerance","frontBackTolerance"],Ee=()=>{if(!("serviceWorker"in navigator))return;const e="/letterpaths/freehand_tracing/";navigator.serviceWorker.register(`${e}sw.js`,{scope:e}).catch(t=>{console.error("Failed to register freehand tracing service worker.",t)})},J=document.querySelector("#app");if(!J)throw new Error("Missing #app element for freehand tracing app.");Ee();J.innerHTML=`
...
`;const f=document.querySelector("#word-input"),Q=document.querySelector("#score-value"),Y=document.querySelector("#progress-value"),x=document.querySelector("#tolerance-slider"),ee=document.querySelector("#tolerance-value"),S=document.querySelector("#front-back-tolerance-slider"),te=document.querySelector("#front-back-tolerance-value"),ne=document.querySelector("#reset-button"),i=document.querySelector("#freehand-svg"),re=document.querySelector("#success-overlay"),ae=document.querySelector("#score-summary"),se=document.querySelector("#try-again-button"),ie=document.querySelector("#next-word-button");if(!f||!Q||!Y||!x||!ee||!S||!te||!ne||!i||!re||!ae||!se||!ie)throw new Error("Missing elements for freehand tracing app.");let oe=-1,_=k,d=W,c=U,C=null,L=null,o=[],I=[],m=null,y=null,p=null,$=null,w=null,E=null,g=null,M=null,u=0,b=[];const le=e=>e.trim().replace(/\s+/g," "),Te=e=>{if(e.step==="any"||e.step.length===0)return 0;const[,t=""]=e.step.split(".");return t.length},R=(e,t)=>{const r=Number(e.min),n=Number(e.max),s=e.step==="any"?Number.NaN:Number(e.step),l=Number.isFinite(r)?r:0;let a=t;return Number.isFinite(r)&&(a=Math.max(r,a)),Number.isFinite(n)&&(a=Math.min(n,a)),Number.isFinite(s)&&s>0&&(a=l+Math.round((a-l)/s)*s),Number.isFinite(r)&&(a=Math.max(r,a)),Number.isFinite(n)&&(a=Math.min(n,a)),Number(a.toFixed(Te(e)))},V=()=>{ee.textContent=`${d}px`,te.textContent=`${c}px`},O=()=>{const e=new URL(window.location.href);$e.forEach(n=>{e.searchParams.delete(n)}),_!==k&&e.searchParams.set("word",_),d!==W&&e.searchParams.set("tolerance",String(d)),c!==U&&e.searchParams.set("frontBackTolerance",String(c));const t=`${e.pathname}${e.search}${e.hash}`,r=`${window.location.pathname}${window.location.search}${window.location.hash}`;t!==r&&window.history.replaceState(null,"",t)},Ae=()=>{const e=new URLSearchParams(window.location.search),t=e.get("word"),r=e.get("tolerance"),n=e.get("frontBackTolerance");if(t!==null&&(_=le(t)),r!==null){const s=Number(r);Number.isFinite(s)&&(d=R(x,s))}if(n!==null){const s=Number(n);Number.isFinite(s)&&(c=R(S,s))}f.value=_,x.value=String(d),S.value=String(c),V(),O()},Me=e=>e.strokes.flatMap((t,r)=>t.samples.map((n,s)=>({x:n.x,y:n.y,tangent:n.tangent,strokeIndex:r,sampleIndex:s,completed:!1,error:null}))),ce=e=>{if(e.length===0)return"";const[t,...r]=e;return`M ${t.x} ${t.y}${r.map(n=>` L ${n.x} ${n.y}`).join("")}`},Pe=()=>{const e=o.slice(0,u);let t="",r=null;return e.forEach(n=>{if(n.strokeIndex!==r){t+=` M ${n.x} ${n.y}`,r=n.strokeIndex;return}t+=` L ${n.x} ${n.y}`}),t.trim()},X=()=>{if(b.length===0)return null;const e=b.reduce((r,n)=>r+n,0)/b.length;if(e<=.5)return 100;const t=Math.min(1,e/d);return Math.max(0,Math.round((1-t)*100))},Ne=e=>({x:-e.y,y:e.x}),N=(e,t)=>e.x*t.x+e.y*t.y,H=(e,t)=>({x:e.x-t.x,y:e.y-t.y}),Ce=(e,t,r)=>({x:e.x+(t.x-e.x)*r,y:e.y+(t.y-e.y)*r}),ke=(e,t,r)=>{const n=Ne(e.tangent),s=H(t,e),l=H(r,e),a=N(s,e.tangent),h=N(l,e.tangent);if(Math.hypot(r.x-t.x,r.y-t.y)<=.001){const j=Math.abs(N(s,n));return{distance:j,isHit:Math.abs(a)<=c&&j<=d}}if(!(a<=c&&h>=-c||h<=c&&a>=-c))return{distance:Number.POSITIVE_INFINITY,isHit:!1};const A=h-a,B=Math.abs(A)<=.001?0:Math.max(0,Math.min(1,(0-a)/A)),D=Ce(t,r,B),P=Math.abs(N(H(D,e),n));return{distance:P,isHit:P<=d}},F=e=>{re.hidden=!e},T=()=>{const e=o.length===0?0:Math.round(u/o.length*100),t=X();Y.textContent=`${e}%`,Q.textContent=t===null?"--":`${t}`,$==null||$.setAttribute("d",Pe()),I.forEach((n,s)=>{const l=o[s],a=s<u,h=s===u,v=s-u,A=v>=0&&v<G,B=A?Math.max(0,1-v/(G-1)):0;if(n.classList.toggle("writing-app__freehand-arrow--done",a),n.classList.toggle("writing-app__freehand-arrow--current",h),n.classList.toggle("writing-app__freehand-arrow--hidden",!A),n.style.opacity=a?"0":B.toFixed(2),a&&n.parentElement!==m?m==null||m.append(n):!a&&n.parentElement!==y&&(y==null||y.append(n)),l){const D=Math.atan2(l.tangent.y,l.tangent.x)*(180/Math.PI),P=h?1.25:1;n.setAttribute("transform",`translate(${l.x} ${l.y}) rotate(${D}) scale(${P})`)}});const r=o[u];if(p&&r){const n=Math.atan2(r.tangent.y,r.tangent.x)*(180/Math.PI);p.style.display="none",p.setAttribute("x",String(-c)),p.setAttribute("y",String(-d)),p.setAttribute("width",String(c*2)),p.setAttribute("height",String(d*2)),p.setAttribute("transform",`translate(${r.x} ${r.y}) rotate(${n})`)}else p&&(p.style.display="none");if(u>=o.length&&o.length>0){const n=X()??0,s=b.reduce((l,a)=>l+a,0)/Math.max(1,b.length);ae.textContent=`Score ${n}. Average distance from the checkpoints: ${Math.round(s)}px.`,F(!0)}},K=()=>{E=null,g=null,M=null,u=0,b=[],o=o.map(e=>({...e,completed:!1,error:null})),w==null||w.replaceChildren(),F(!1),T()},Le=e=>{const t=document.createElementNS("http://www.w3.org/2000/svg","path");return t.setAttribute("class",e),t.setAttribute("d",""),t},Ie=(e,t,r,n)=>{L=de(e,{sampleRate:be}),o=Me(L);const s=e.strokes.filter(a=>a.type!=="lift").map(a=>`<path class="writing-app__freehand-guide" d="${me(a.curves)}"></path>`).join(""),l=o.map((a,h)=>{const v=Math.atan2(a.tangent.y,a.tangent.x)*(180/Math.PI);return`
  ...
  `,I=Array.from(i.querySelectorAll(".writing-app__freehand-arrow")),m=i.querySelector("#completed-arrows"),y=i.querySelector("#remaining-arrows"),p=i.querySelector("#tolerance-gate"),$=i.querySelector("#completed-checkpoint-path"),w=i.querySelector("#user-ink"),K()},q=(e,t=-1)=>{if(_=le(e),oe=t,f.value=_,O(),_.length===0){C=null,L=null,o=[],I=[],m=null,y=null,p=null,$=null,w=null,i.innerHTML="",T(),F(!1);return}try{const r=we(_);C=r.path,Ie(r.path,r.width,r.height,r.offsetY)}catch{C=null,L=null,o=[],I=[],m=null,y=null,p=null,$=null,w=null,i.innerHTML="",T(),F(!1)}},pe=(e,t)=>{const r=Math.hypot(t.x-e.x,t.y-e.y)<=.001;let n=o[u];for(;n;){const s=ke(n,e,t);if(!s.isHit||(n.completed=!0,n.error=s.distance,b.push(s.distance),u+=1,r))break;n=o[u]}T()},Re=e=>{if(!w)return;const t=Le("writing-app__freehand-user-stroke");w.append(t),g={points:[e],pathEl:t},t.setAttribute("d",ce(g.points))},Fe=e=>{if(!g)return;const t=g.points[g.points.length-1];t&&Math.hypot(e.x-t.x,e.y-t.y)<2||(g.points.push(e),g.pathEl.setAttribute("d",ce(g.points)))},Oe=e=>{if(!C||E!==null||u>=o.length)return;e.preventDefault();const t=Z(i,e);E=e.pointerId,M=t,Re(t),pe(t,t),i.setPointerCapture(e.pointerId)},qe=e=>{if(e.pointerId!==E)return;e.preventDefault();const t=Z(i,e),r=M??t;Fe(t),pe(r,t),M=t},ue=e=>{e.pointerId===E&&(i.hasPointerCapture(e.pointerId)&&i.releasePointerCapture(e.pointerId),E=null,g=null,M=null)},Be=()=>{const e=ye(oe);q(z[e]??z[0],e)};i.addEventListener("pointerdown",Oe);i.addEventListener("pointermove",qe);i.addEventListener("pointerup",ue);i.addEventListener("pointercancel",ue);f.addEventListener("change",()=>{q(f.value)});f.addEventListener("keydown",e=>{e.key==="Enter"&&(f.blur(),q(f.value))});x.addEventListener("input",()=>{d=R(x,Number(x.value)),V(),O(),T()});S.addEventListener("input",()=>{c=R(S,Number(S.value)),V(),O(),T()});ne.addEventListener("click",K);se.addEventListener("click",K);ie.addEventListener("click",Be);Ae();q(_);
