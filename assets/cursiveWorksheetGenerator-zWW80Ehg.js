import"./Z-upper-print-bezier-o7EP_mHt.js";import{c as Me}from"./style-Ye0bKBwL.js";import{g as ze,d as Fe,c as He,a as Ue}from"./joiner-DKFU46we.js";import{a as je}from"./annotations-DHyvYmdP.js";import{s as Be,E as Ve,D as Ze,b as qe}from"./worksheet-preview-pan-zoom-B5XItdrb.js";import{c as Xe,a as Ye}from"./shared-CqTCxrjP.js";const re="path, polygon, polyline, line, rect, circle, ellipse, text",Ke=1e4,Je=e=>Array.from(e.querySelectorAll("svg")).reduce((r,t)=>{const i=t.querySelectorAll(re).length,o=Array.from(t.querySelectorAll("defs")).reduce((l,m)=>l+m.querySelectorAll(re).length,0),n=t.querySelectorAll("use").length,s=o*Math.max(1,n);return r+Math.max(0,i-o)+s},0),Qe=(e,r=Ke)=>Je(e)>r,de="zephyr",ce=96,U=320,ue=13,et=53,tt=53,j=26,rt=5.6,it=ue*2,at=0,ot="#3f454b",nt="#ffffff",st="#83b0dd",lt="#d5dbe2",he=24,we=1,pe=54,me=1,fe="#ffb35c",q=100,ge=35,be=200,A=5,dt=20,ct=178,ut=.63,ht=.66,x=2,ie="http://www.w3.org/2000/svg",wt=`
