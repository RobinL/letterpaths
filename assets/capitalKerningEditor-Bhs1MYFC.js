import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css             */import{a as ne}from"./bigram-frequency-BYeZ3rJA.js";import{j as ie,e as ae,l as re}from"./joiner-CaP30BL7.js";const X=document.querySelector("#app");if(!X)throw new Error("Missing #app element for capital kerning editor.");const u={xHeight:360,baseline:720},m=ne.map(e=>{var t;return`${(t=e[0])==null?void 0:t.toUpperCase()}${e[1]}`}),A=new Map(m.map((e,t)=>[e,t])),R=-400,T=500,G=40,D=e=>Math.round(e*10)/10,B=e=>Math.min(T,Math.max(R,e)),k=e=>e.toFixed(1),J=e=>e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;");let r=W(ie),a=m[0]??"Th",d="withLeadIn",E="all",U="",h=null,x="packages/letterpaths/src/data/capital-to-lowercase-kerning.json",f=!1,g=null;X.innerHTML=`
