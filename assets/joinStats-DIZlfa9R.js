import"./Z-upper-print-bezier-o7EP_mHt.js";/* empty css             */import{h as V,b as W,C as K,l as U}from"./joiner-C20HBd4f.js";const R=document.querySelector("#app");if(!R)throw new Error("Missing #app element for join stats.");const Q="cursive",Z={xHeight:360,baseline:720},tt=U,b=[{key:"sidebearingGapAdjustment",label:"Letter spacing adjustment",min:-120,max:120,step:5,value:V.sidebearingGapAdjustment}];R.innerHTML=`
