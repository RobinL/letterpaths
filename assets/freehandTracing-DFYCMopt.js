import"./modulepreload-polyfill-B5Qt9EMX.js";import{c as ue}from"./style-GuMfYcru.js";import"./joiner-CaP30BL7.js";import{M as de,d as ge,T as _e,f as he,g as X,c as we,W as j,a as fe,e as me}from"./shared-BgZ7yO6P.js";const k="zephyr",ye=84,H=he,W=70,be=0,ve=120,xe=1,z=5,Ee=["word","tolerance","frontBackTolerance"],Se=()=>{if(!("serviceWorker"in navigator))return;const e="/letterpaths/freehand_tracing/";navigator.serviceWorker.register(`${e}sw.js`,{scope:e}).catch(t=>{console.error("Failed to register freehand tracing service worker.",t)})},Z=document.querySelector("#app");if(!Z)throw new Error("Missing #app element for freehand tracing app.");Se();Z.innerHTML=`
